...
\vspace{5pt}
\resumeSubItem{\large Zomato-clone}{ \large This is a clone of zomato website(2020 editon). Here tech stack is react and for css Tailwindcss is used.Here you can see good file structure and good animation and on hover animation. }\href{https://github.com/Jayabrata18/zomato-clone}{\normalsize Link to Github \faExternalLink}
\vspace{5pt}
\resumeSubItem{\large Cred.club clone}{\large This is a clone of website cred.club.Here you can see animation Hamburger icon, window structure, animate on scroll functionality. TECH: React and CSS}\href{https://github.com/Jayabrata18/cred-clud-clone}{\normalsize Link to Github \faExternalLink}
\vspace{5pt}
\resumeSubItem{\large Quiz App}{\large This is a basic quiz app with four available options.Tech: React-native-cli.Questions are taken form external api and integrated with main-project.This is a quiz app where one can participate and get marks based on 10 questions.Questions never repeats.}\href{https://github.com/Jayabrata18/Quiz-App}{\normalsize Link to Github \faExternalLink}
\vspace{5pt}
